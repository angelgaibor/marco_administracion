...
if(sum(grepl(paste0(encuesta,"_",periodo), names(marco))) == 0){
  ...
  marco_01 <- marco |> 
    ...
    mutate(aux_estrato = ifelse(Mi < Mi_min, "9999", estrato),
           aux_seleccionable = case_when(enciet_202507_sel == 1 ~ 13,
...
table(marco_01$enciet_202411_sel, marco_01$enciet_202508_sel)
table(marco_01$enighur_sel, marco_01$enciet_202508_sel)
table(marco_01$endi3_sel, marco_01$enciet_202508_sel)
