...
marco_upm_22 <- readRDS("productos/01_general/marco_upm_22.rds")
...
marco_upm_22 %>% filter(id_upm == "070150085601") %>% select(estrato)
...
aux_1 <- marco_upm_22 %>% 
  ...
  select(id_upm, estrato, enighur_orden ,
         grep(names(marco_upm_22), pattern = "_sel$")) %>% 
...
ruta <- "productos/02_seleccion/09_enighur_reemplazo_002/"

muestra_enighur_reemplazo <- marco_upm_23 %>% 
...
export(marco_upm_23, "productos/01_general/marco_upm_23.rds")
