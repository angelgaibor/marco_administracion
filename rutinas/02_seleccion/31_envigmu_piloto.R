...
if(sum(grepl(encuesta, names(marco))) == 0){
  ...
  mutate(prov = substr(id_upm, 1, 2),
         ...
         aux = ifelse(veri_amanz == 9, "disper", "aman"), 
         id_dom_piloto = case_when(cant %in% c("0307", "0901", "1806",  "1807", "0608") ~ paste0(cant, "00"),
                                   T ~ parr), 
         id_dom_piloto = paste0(id_dom_piloto, "_", aux),
         aux_estrato = ifelse(Mi < Mi_min, "9999", id_dom_piloto),
          
         
    aux_seleccionable = case_when(envigmu_sel == 1 ~ 18,
                                  enighur_sel == 1 ~ 17,
                                  steps_202506_sel == 1 ~ 16,
                                  endi3_sel == 1 ~ 15,
                                  enciet_202511_sel == 1 ~ 14,
                                  enciet_202510_sel == 1 ~ 13,
                                  enciet_202509_sel == 1 ~ 12,
                                  enciet_202508_sel == 1 ~ 11,
                                  enciet_202507_sel == 1 ~ 10,
                                  enciet_202506_sel == 1 ~ 9,
                                  enciet_202505_sel == 1 ~ 8,
                                  enciet_202504_sel == 1 ~ 7,
                                  enciet_202503_sel == 1 ~ 6,
                                  enciet_202502_sel == 1 ~ 5,
                                  enciet_202501_sel == 1 ~ 4,
                                  enciet_202412_sel == 1 ~ 3,
                                  enciet_202411_sel == 1 ~ 2,
                                  T ~ 1)) |>  
  ...
  muestra <- marco_01 |>
    ...
    select(c("id_upm", "pro", "area", "estrato", envigmu_piloto_estrato, Mi, paste0(encuesta, "_pii")))
