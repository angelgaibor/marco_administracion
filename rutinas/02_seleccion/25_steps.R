...
if(sum(grepl(paste0(encuesta,"_",periodo), names(marco))) == 0){
  ...
  marco_01 <- marco |> 
    ...
    mutate(aux_estrato = ifelse(Mi < Mi_min, "9999", estrato),
           aux_seleccionable = case_when(enciet_202509_sel == 1 ~ 14,
                                         enciet_202508_sel == 1 ~ 13,
                                         enciet_202507_sel == 1 ~ 12,
                                         enciet_202506_sel == 1 ~ 11,
                                         enciet_202505_sel == 1 ~ 10,
                                         enciet_202504_sel == 1 ~ 9,
                                         enciet_202503_sel == 1 ~ 8,
                                         enciet_202502_sel == 1 ~ 7,
                                         enciet_202501_sel == 1 ~ 6,
