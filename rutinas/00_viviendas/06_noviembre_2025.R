...
redistribucion_02 <- redistribucion_01 |> 
  mutate(id_upm4 = case_when(# Casos particulares
    ...
    id_conglomerado == "2101500167" & id_upm3 == "asignar" ~ "210150016702",
    T ~ id_upm3))
...
names(enlistamiento_05)[!names(enlistamiento_05) %in% names(marco_old1)]
names(marco_old1)[!names(marco_old1) %in% names(enlistamiento_05)]
